    ...
    if (userCount === 0) {
      await UserModel.insertMany([
        ...
        },
        {
          ...
          allowedModules: ['dashboard', 'projects', 'tasks', 'checklist', 'team', 'attendance', 'performance', 'live-workplace', 'notice-board', 'domain-monitoring'],
          allowedWorkModes: ['office', 'wfh'],
          status: 'active',
          loginLocked: false,
          privacyModeEnabled: false,
        ...
        },
        {
          ...
          allowedModules: ['dashboard', 'projects', 'tasks', 'checklist', 'attendance', 'performance', 'notice-board', 'domain-monitoring'],
          allowedWorkModes: ['office', 'wfh'],
          status: 'active',
          loginLocked: false,
        ...
        },
        {
          ...
          allowedModules: ['dashboard', 'tasks', 'projects', 'checklist', 'attendance', 'performance', 'notice-board', 'domain-monitoring'],
        ...
        },
        {
          ...
          allowedModules: ['dashboard', 'checklist', 'tasks', 'projects', 'notice-board', 'domain-monitoring'],
          allowedWorkModes: ['office', 'wfh'],
          status: 'active',
          loginLocked: false,
          privacyModeEnabled: false,
